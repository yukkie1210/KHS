...
"""autogenerated by genpy from kxr_controller/PressureControlActionResult.msg. Do not edit."""
import codecs
import sys
...
class PressureControlActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "kxr_controller/PressureControlActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','kxr_controller/PressureControlResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PressureControlActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = kxr_controller.msg.PressureControlResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = kxr_controller.msg.PressureControlResult()

...
"""autogenerated by genpy from kxr_controller/ServoOnOffAction.msg. Do not edit."""
import codecs
import sys
...
class ServoOnOffAction(genpy.Message):
  _md5sum = "a2cdc6dbac89d831c57c373c3cbc9da8"
  _type = "kxr_controller/ServoOnOffAction"
...
"""
  ...
  _slot_types = ['kxr_controller/ServoOnOffActionGoal','kxr_controller/ServoOnOffActionResult','kxr_controller/ServoOnOffActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ServoOnOffAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = kxr_controller.msg.ServoOnOffActionGoal()
      if self.action_result is None:
        self.action_result = kxr_controller.msg.ServoOnOffActionResult()
      if self.action_feedback is None:
        self.action_feedback = kxr_controller.msg.ServoOnOffActionFeedback()
    else:
      self.action_goal = kxr_controller.msg.ServoOnOffActionGoal()
      self.action_result = kxr_controller.msg.ServoOnOffActionResult()
      self.action_feedback = kxr_controller.msg.ServoOnOffActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.action_goal.goal.servo_on_states)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.servo_on_states))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_goal.goal.servo_on_states = s.unpack(str[start:end])
      self.action_goal.goal.servo_on_states = list(map(bool, self.action_goal.goal.servo_on_states))
      _x = self
      start = end
      end += 12
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(self.action_goal.goal.servo_on_states.tostring())
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      _x = self.action_result.header.frame_id
      length = len(_x)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_goal.goal.servo_on_states = numpy.frombuffer(str[start:end], dtype=numpy.bool, count=length)
      self.action_goal.goal.servo_on_states = list(map(bool, self.action_goal.goal.servo_on_states))
      _x = self
      start = end
      end += 12

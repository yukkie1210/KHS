...
"""autogenerated by genpy from kxr_controller/ServoOnOffActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class ServoOnOffActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "kxr_controller/ServoOnOffActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','kxr_controller/ServoOnOffFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ServoOnOffActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = kxr_controller.msg.ServoOnOffFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = kxr_controller.msg.ServoOnOffFeedback()

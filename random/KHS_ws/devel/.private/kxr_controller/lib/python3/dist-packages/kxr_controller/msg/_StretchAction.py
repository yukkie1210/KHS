...
"""autogenerated by genpy from kxr_controller/StretchAction.msg. Do not edit."""
import codecs
import sys
...
class StretchAction(genpy.Message):
  _md5sum = "4e836a85767fdb254c9f0891ee820e23"
  _type = "kxr_controller/StretchAction"
...
"""
  ...
  _slot_types = ['kxr_controller/StretchActionGoal','kxr_controller/StretchActionResult','kxr_controller/StretchActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StretchAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = kxr_controller.msg.StretchActionGoal()
      if self.action_result is None:
        self.action_result = kxr_controller.msg.StretchActionResult()
      if self.action_feedback is None:
        self.action_feedback = kxr_controller.msg.StretchActionFeedback()
    else:
      self.action_goal = kxr_controller.msg.StretchActionGoal()
      self.action_result = kxr_controller.msg.StretchActionResult()
      self.action_feedback = kxr_controller.msg.StretchActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_i3I().pack(_x.action_goal.goal.stretch, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.stretch, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_i3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end

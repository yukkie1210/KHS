...
let ServoOnOffFeedback = require('./ServoOnOffFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class ServoOnOffActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ServoOnOffFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ServoOnOffFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ServoOnOffActionFeedback(null);
    ...
    data.feedback = ServoOnOffFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ServoOnOffActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ServoOnOffFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ServoOnOffFeedback()
    }
...
module.exports = ServoOnOffActionFeedback;

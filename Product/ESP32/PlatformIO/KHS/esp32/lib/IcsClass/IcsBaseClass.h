...
class IcsBaseClass 
{
  ...
  public:
  //サーボID範囲 ////////////////////////////////////
  static constexpr int MAX_ID = 8;   ///< サーボIDの最大値
  static constexpr int MIN_ID = 1;    ///< サーボIDの最小値
  ...
  static constexpr float MAX_DEG = 100.0; ///< 角度の最大値

  //  static const float MIN_DEG = -135.0; 
  static constexpr float MIN_DEG = -100.0;  ///< 角度の最大値

  //static const int MAX_100DEG = 13500;
  static constexpr int MAX_100DEG = 10000;  ///< 角度(x100)の最大値
  
  //static const int MIN_100DEG = -13500;
  static constexpr int MIN_100DEG = -10000; ///< 角度(x100)の最小値
